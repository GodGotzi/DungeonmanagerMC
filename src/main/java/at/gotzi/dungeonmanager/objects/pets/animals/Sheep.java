...
public class Sheep extends EntitySheep implements CustomPet {
    private final Player player;

    public Sheep(Location location, Player player, String name) {
        super(EntityTypes.ax, ((CraftWorld)location.getWorld()).getHandle());
