...
public class Chicken extends EntityChicken implements CustomPet {
    private final Player player;

    public Chicken(Location location, Player player, String name) {
        super(EntityTypes.l, ((CraftWorld)location.getWorld()).getHandle());
