...
public class Wolf extends EntityWolf implements CustomPet {

    private final Player player;

    public Wolf(Location location, Player player, String name) {
        super(EntityTypes.bc, ((CraftWorld)location.getWorld()).getHandle());
